...
public class NoStreamHandler implements ActionListener
{
    ...
    NoStreamHandler(Connection connection, JTable table, DefaultTableModel model, JScrollPane scroller, JFrame myFrameClass) {
    ...
    {
            try {
                String query = "SELECT title, genre, release_date, hyperlink, view_count\r\n"
                		+ "FROM video\r\n"
                		+ "WHERE view_count = 0\r\n"
                		;
