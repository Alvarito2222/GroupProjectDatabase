...
class DirectorMenuHandler implements ActionListener {
    ...
    DirectorMenuHandler(Connection connection, JTable table, DefaultTableModel model, JScrollPane scroller, JFrame myFrameClass) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Object[] message = {
            "Enter Director Name:", searchField
        };

        int optionChosen = JOptionPane.showConfirmDialog(null, message, "Search by Director", JOptionPane.OK_CANCEL_OPTION);
