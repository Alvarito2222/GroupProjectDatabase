...
class SequelMenuHandler implements ActionListener {
    ...
    SequelMenuHandler(Connection connection, JTable table, DefaultTableModel model, JScrollPane scroller, JFrame myFrameClass) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (optionChosen == JOptionPane.OK_OPTION) {
            ...
            try {
                String query = "SELECT * FROM sequel WHERE prequel LIKE ? OR sequel LIKE ?";
