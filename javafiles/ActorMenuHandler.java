...
class ActorMenuHandler implements ActionListener {
    ...
    ActorMenuHandler(Connection connection, JTable table, DefaultTableModel model, JScrollPane scroller, JFrame myFrameClass) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Object[] message = {
            "Enter Actor Name:", searchField
        };
        
        int optionChosen = JOptionPane.showConfirmDialog(null, message, "Search by Actor", JOptionPane.OK_CANCEL_OPTION);
