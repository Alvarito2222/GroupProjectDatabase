...
public class TopTenHandler implements ActionListener
{
    ...
    TopTenHandler(Connection connection, JTable table, DefaultTableModel model, JScrollPane scroller, JFrame myFrameClass) {
    ...
    public void actionPerformed(ActionEvent e) 
    {
            try {
                String query = "SELECT title, COUNT(title) AS stream_count\r\n"
                		...
                		+ "WHERE stream_datetime > NOW() - INTERVAL 24 HOUR\r\n"
                		+ "GROUP BY title\r\n"
